...
#flash of three part 
python ~/esp/esp-idf/components/esptool_py/esptool/esptool.py --chip esp32 --port /dev/ttyUSB0 --baud 921600 write_flash -z 0x1000 _crypt_build/bootloader_enc.bin 0x8000 _crypt_build/gme-enc-tab.bin 0x10000 _crypt_build/gme-enc-app.bin
